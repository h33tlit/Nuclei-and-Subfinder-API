...
To get nuclei results (WITHOUT AUTOSCAN): `http://127.0.0.1/api/v2/scanner2?target_name=https://jubaeralnazi.com&autoscan=false&tags=misconfig,cve,panel`

![image](https://user-images.githubusercontent.com/97327489/189568842-52aee7f9-dd85-421e-9fca-5f2a384d913e.png)


To get nuclei results (WITH AUTOSCAN): `http://127.0.0.1/api/v2/scanner2?target_name=https://jubaeralnazi.com&autoscan=true`
